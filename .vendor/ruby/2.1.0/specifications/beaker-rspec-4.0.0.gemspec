# -*- encoding: utf-8 -*-
# stub: beaker-rspec 4.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<serverspec>, ["~> 1.0"])
      s.add_runtime_dependency(%q<specinfra>, ["~> 1.0"])
    else
      ...
      s.add_dependency(%q<serverspec>, ["~> 1.0"])
      s.add_dependency(%q<specinfra>, ["~> 1.0"])
    end
  else
    s.add_dependency(%q<minitest>, ["~> 5.4"])
    s.add_dependency(%q<fakefs>, ["~> 0.6"])
